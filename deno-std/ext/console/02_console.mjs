...
import * as colors from "./01_colors";
...
function hasOwnProperty(obj, v) {
  ...
  return Object.prototype.hasOwnProperty(obj, v);
}
...
function propertyIsEnumerable(obj, prop) {
  ...
  return Object.prototype.propertyIsEnumerable(obj, prop);
}
...
function isTypedArray(x) {
  return (
    ...
    !Object.prototype.isPrototypeOf.call(DataView.prototype, x)
  );
}
...
function inspectArray(value, level, inspectOptions) {
  ...
  const options = {
    ...
    entryHandler: (entry, level, inspectOptions, next) => {
      ...
      let i = index;
      if (!Object.prototype.hasOwnProperty(value, i)) {
        i++;
        while (!Object.prototype.hasOwnProperty(value, i) && i < value.length) {
          next();
          i++;
        }
...
function inspectRawObject(value, level, inspectOptions) {
  ...
  const totalLength =
    entries.length + level + colors.stripColor(entries.join("")).length;
...
function inspectObject(value, level, inspectOptions, proxyDetails) {
  if (customInspect in value && typeof value[customInspect] === "function") {
    return String(value[customInspect](inspect));
  }
  ...
  if (Object.prototype.isPrototypeOf.call(Error.prototype, value)) {
    return inspectError(value, maybeColor(colors.cyan, inspectOptions));
  } else if (Array.isArray(value)) {
    return inspectArray(value, level, inspectOptions);
  } else if (Object.prototype.isPrototypeOf.call(Number.prototype, value)) {
    return inspectNumberObject(value, inspectOptions);
  } else if (Object.prototype.isPrototypeOf.call(BigInt.prototype, value)) {
    return inspectBigIntObject(value, inspectOptions);
  } else if (Object.prototype.isPrototypeOf.call(Boolean.prototype, value)) {
    return inspectBooleanObject(value, inspectOptions);
  } else if (Object.prototype.isPrototypeOf.call(String.prototype, value)) {
    return inspectStringObject(value, inspectOptions);
  } else if (Object.prototype.isPrototypeOf.call(Symbol.prototype, value)) {
    return inspectSymbolObject(value, inspectOptions);
  } else if (Object.prototype.isPrototypeOf.call(Promise.prototype, value)) {
    return inspectPromise(value, level, inspectOptions);
  } else if (Object.prototype.isPrototypeOf.call(RegExp.prototype, value)) {
    return inspectRegExp(value, inspectOptions);
  } else if (Object.prototype.isPrototypeOf.call(Date.prototype, value)) {
    return inspectDate(value, inspectOptions);
  } else if (Object.prototype.isPrototypeOf.call(Set.prototype, value)) {
    return inspectSet(
      proxyDetails ? proxyDetails[0] : value,
      level,
      inspectOptions
    );
  } else if (Object.prototype.isPrototypeOf.call(Map.prototype, value)) {
    return inspectMap(
      proxyDetails ? proxyDetails[0] : value,
      level,
      inspectOptions
    );
  } else if (Object.prototype.isPrototypeOf.call(WeakSet.prototype, value)) {
    return inspectWeakSet(inspectOptions);
  } else if (Object.prototype.isPrototypeOf.call(WeakMap.prototype, value)) {
...
export class Console {
  ...
  constructor(printFunc) {
    ...
    // by Object.create(%ObjectPrototype%), instead of %ObjectPrototype%.
  ...
  table = (data = undefined, properties = undefined) => {
    ...
    let resultData;
    const isSet = Object.prototype.isPrototypeOf.call(Set.prototype, data);
    const isMap = Object.prototype.isPrototypeOf.call(Map.prototype, data);
...
export function createFilteredInspectProxy({ object, keys, evaluate }) {
  ...
  function getDescendantPropertyDescriptor(object, key) {
    let propertyDescriptor = Reflect.getOwnPropertyDescriptor(object, key);
...
//     if (Object.prototype.hasOwnProperty(consoleFromDeno, key)) {
